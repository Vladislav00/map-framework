...
Codex: ## Found Incomplete Workflow
...
Codex: Resuming workflow from ST-004 (phase: ACTOR)...
...
Codex: State cleared. Start fresh with $map-efficient.
```
