...
<!--
  ...
  WHEN: Update after ANY discovery, especially from researcher output.
-->
...
<!--
  ...
  WHEN: Update after researcher returns, or after exploring code.
-->
-
...
---
*Update after researcher output or codebase exploration*
