...
def main() -> None:
    ...
    elif input_data.get("hook_event_name") == "SubagentStop":
        # Codex exposes the completed subagent through the ordinary transcript
        # field and identifies it with agent_type.
        transcript_path = input_data.get("transcript_path", "")
        agent = str(input_data.get("agent_type", "") or "subagent")
    else:
        transcript_path = input_data.get("transcript_path", "")
